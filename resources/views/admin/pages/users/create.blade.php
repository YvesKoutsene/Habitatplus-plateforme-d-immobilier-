            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Information sur l'utilisateur</h5>
                        ...
                        <div class="mb-3">
                            <label for="phone" class="form-label">Téléphone<span class="text-danger" title="obligatoire">*</span></label>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="dropdown">
                                        <input type="text" id="searchIndicatif" class="form-control" placeholder="Rechercher un indicatif" onfocus="showDropdown()" oninput="filterOptions()" required>
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="numero" class="form-control" id="numero" oninput="validateInput()" required placeholder="Numero de téléphone de l'utilisateur">
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
            fetch('https://restcountries.com/v3.1/all?fields=name,idd,translations')
