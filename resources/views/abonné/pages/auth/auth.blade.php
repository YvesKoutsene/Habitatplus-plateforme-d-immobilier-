            ...
            <div class="modal-body">
                ...
                <div class="tab-content" id="authTabContent">
                    <div class="tab-pane fade" id="registerSection" role="tabpanel" aria-labelledby="register-tab">
                        <form action="{{ route('register') }}" method="POST" onsubmit="showLoading()"> <!--onsubmit="return handleFormSubmit()"-->
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3 text-end">
                                <label for="code" class="form-label text-black">Code parrainage <span class="text-info" title="Ceci vous permettra de gagner 50 points de boost"><i class="bi bi-info-circle"></i></span></label>
                                <input type="text" class="form-control form-control-sm" id="code" name="code" placeholder="Entrer si vous en avez un">
                            </div>
